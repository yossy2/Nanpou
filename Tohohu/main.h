...
#define BIG_BLAST_ANIM_MAX 14	// ﾎﾞｽの爆発ｱﾆﾒｰｼｮﾝ数
...
MAIN_EX int eShotSound;					// 敵の弾の効果音
MAIN_EX int blastSound;					// 爆発音

MAIN_EX Vector2 shake;					// 画面を揺らす
MAIN_EX int bigBlastImg[BIG_BLAST_ANIM_MAX];	// ﾎﾞｽ用の爆発画像
MAIN_EX int bigBlastSound;						// 爆発効果音
